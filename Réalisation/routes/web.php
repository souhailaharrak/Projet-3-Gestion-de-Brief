...
Route::get('/assignerpromotion/{id1}/brief/{id2}','BriefController@assigner')->name("assignerbrief");
...
Route::get('/assignement', [AssignController::class, 'ajouter'])->name('assignement.ajouter');
Route::get('/promotion/{idpromotion}/briefs','PromotionController@lesbriefsdecettepromotion')->name('promotion.briefs');
Route::get('/assignertout/{promo}/{brief}','AssignerController@ajouter')->name('assignertous');

Route::get('ajouterbriefpromo/{id}','BriefController@ajouter_2')->name("brief.addpromobrief");
Route::post('/sauvegarderpromobrief/{id}','BriefController@enregistrer_brfprm')->name("brief.ajouterbriefpromotion");
