                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item active position-absolute start-50 translate-middle">
                            <a class="nav-link active" aria-current="page" href="#"><h3 style="color: wheat">Promotion</h3></a>
                        </li>

                        <li class="nav-item  active position-absolute  start-50">
                            <a class="nav-link active" href="#"  aria-disabled="true"><h3 style="color: wheat;margin-left:55px;margin-top:-25px">Brief</h3></a>
                        </li>
                    </ul>
